...
export const skills = {
  ...
  skills: [
    ...
    },
    {
      ...
      description: "Expressを使ったWebアプリケーションの開発経験があります。",
    },
    {
      name: "flask",
    ...
    {
      name: "nginx",
      icon: <i class="devicon-nginx-original"></i>,
      description: "Nginxを使ったWebアプリケーションの開発経験があります。",
    },
    {
      name: "FastAPI",
      icon: <i class="devicon-fastapi-plain"></i>,
      description: "FastAPIを使ったWebアプリケーションの開発経験があります。",
    },
    {
      name: "flutter",
