			...
			<div className='flex flex-col gap-6'>
				{reverse.map(({ date, event, role, id, status}) => (
					<div key={role} className='flex ml-10'>
						<div className='mr-8'>
                            <div className="mx-auto w-1 h-4 bg-grey"></div>
                            <div className="bg-grey rounded-full h-6 w-6">
                                {id == 1 ?
                                    <div className="mx-auto w-1 h-20 md:10 bg-grey"></div> : <div className="mx-auto w-1 h-60 md:h-30 bg-grey"></div>
                                }
                            </div>
						</div>
